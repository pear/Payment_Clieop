...
include_once("Payment_Clieop/clieop_transcation.php");
...
$clieopFile->setFixedDesciption("PHP: Scripting the web");		// description for all transactions
$clieopFile->setSenderIndentification("PEAR");					// Free identification
$clieopFile->Test(true);										// Test clieop
